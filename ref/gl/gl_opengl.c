...
void GL_InitCommands( void )
{
	...
	CVAR_DEF_T( rt_light_tramh,				"400",	"intro tram headlights intensity")
	CVAR_DEF_T( rt_light_tram_ao,			"45",	"intro tram headlights outer angle")
	CVAR_DEF_T( rt_light_tram_ai,			"20",	"intro tram headlights inner angle")
...
static rt_batchtype_t GetGlBeginEndType()
{
    if( glState.in2DMode )
    {
