...
#else
	Cvar_Get( "r_fullbright", "0", 0, "RT: IF 1, PERFORMANCE MIGHT BE WORSE; disable lightmaps, get fullbright for entities" );
#endif
...
#else
	Cvar_Get( "r_dynamic", "0", 0, "RT: NOT SUPPORTED; allow dynamic lighting (dlights, lightstyles)" );
#endif
